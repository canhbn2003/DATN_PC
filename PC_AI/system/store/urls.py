...
urlpatterns = [
    ...
    path('recommendations/session/more/', views.session_recommendations_more, name='session_recommendations_more'),
    path('best-sellers/', views.best_sellers_api, name='best_sellers_api'),
