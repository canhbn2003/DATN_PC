...
class UserAddress(models.Model):
    id_user_addresses = models.AutoField(primary_key=True)
    ...
    phone_address = models.CharField(max_length=20, null=True, blank=True)
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["id_users"], name="idx_user_addresses"),
        ]

    def __str__(self):
        return f"{self.address_name or self.full_address} ({self.id_users.name_users})"
...
class WebsiteSettings(models.Model):
    ...
    footer_about = models.CharField(max_length=1000, null=True, blank=True)
    footer_phone = models.CharField(max_length=20, null=True, blank=True)
    footer_email = models.CharField(max_length=100, null=True, blank=True)
    footer_address = models.CharField(max_length=500, null=True, blank=True)
    ...
    def __str__(self):
        return self.website_name or "Cài đặt website"
...
class Order(models.Model):
    ...
    id_user_addresses = models.ForeignKey(
        UserAddress,
        models.DO_NOTHING,
        db_column="id_user_addresses",
        null=True,
        blank=True
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["id_users"], name="idx_orders_user"),
            models.Index(fields=["id_user_addresses"], name="idx_orders_address"),
        ]
